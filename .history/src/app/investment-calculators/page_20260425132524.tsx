        ...
        <section className="padding-global">
          <div className="container-large">
            <div className="investment-hero">
              <p className="investment-kicker">India Investment Suite</p>
              <h1 className="investment-title">Premium Investment Calculator</h1>
              <p className="investment-subtitle">
                Fast, clear projections for SIP, Lumpsum, Goal SIP, FD, SWP, and PPF in one place.
              </p>
              <p className="investment-meta">All estimates are shown in INR and meant for planning purposes.</p>
            </div>
