...
const pressLogos = [
  ...
  { nodeId: 'w-node-_2b28df9e-90c5-70c0-10a2-8fabdaf1769c-90a7bc5a', label: 'GUEST AT BEHIND WOODS' },
  ...
  return (
    <div className="swiper is-press w-dyn-list">
      <div role="list" className="swiper-wrapper is-press w-dyn-items">
        {images.map((src, i) => (
          <div key={i} role="listitem" className="swiper-slide is-press w-dyn-item">
